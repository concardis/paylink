 ...
 */
class Invoice extends \Paylink\Models\Base
{
     ...
     * This name will only be shown to administrator of the Paylink site.
     *
     * @param string $name
     */
     ...
     * A list of available currencies you can find on http://developers.pay-link.eu/docs/miscellaneous
     *
    ...
    {
        return new \Paylink\Models\Response\Invoice();
    }
}
